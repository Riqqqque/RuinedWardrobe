package dev.rique.prismwardrobe.integration.placeholder;
...
public final class PrismWardrobeExpansion extends PlaceholderExpansion {

    private final JavaPlugin plugin;
    private final WardrobeServiceImpl wardrobeService;
    private final SlotLimitServiceImpl slotLimitService;

    public PrismWardrobeExpansion(JavaPlugin plugin, WardrobeServiceImpl wardrobeService, SlotLimitServiceImpl slotLimitService) {
        this.plugin = plugin;
    ...
    public String onPlaceholderRequest(Player player, @NotNull String params) {
        ...
        if (params.toLowerCase().startsWith("set_name_")) {
