package dev.rique.fluxwardrobe.integration.placeholder;
...
public final class FluxWardrobeExpansion extends PlaceholderExpansion {

    private static final String IDENTIFIER = "fluxwardrobe";

    private final JavaPlugin plugin;
    private final WardrobeServiceImpl wardrobeService;
    private final SlotLimitServiceImpl slotLimitService;

    public FluxWardrobeExpansion(
            JavaPlugin plugin,
